...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-engine">
      ...
      <section className="relative h-[85vh] min-h-[600px] w-full flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-20 max-w-5xl mx-auto px-6 text-center mt-16">
          <motion.h1 
            ...
            className="text-5xl md:text-7xl font-display font-black uppercase italic text-chrome tracking-tighter mb-6 drop-shadow-2xl"
          >
            {t('home.hero.title')}
          </motion.h1>
          ...
          >
            ...
            <Link 
              to="/discover" 
              className="w-full sm:w-auto px-8 py-4 bg-transparent border border-inverse/20 text-chrome font-display font-black uppercase italic tracking-widest text-sm rounded-none hover:bg-inverse/10 transition-all skew-x-[-10deg]"
            >
      ...
      <section className="py-24 bg-engine relative z-10 border-t border-inverse/5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <motion.div 
                ...
                className="bg-oil/50 border border-inverse/5 p-8 hover:border-primary/30 transition-colors group"
              >
                <pillar.icon className="w-10 h-10 text-steel group-hover:text-primary transition-colors mb-6" strokeWidth={1.5} />
                <h3 className="text-xl font-display font-black uppercase italic text-chrome mb-3 tracking-tight">{pillar.title}</h3>
      ...
      <section className="py-32 relative bg-oil overflow-hidden border-y border-inverse/5">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-display font-black uppercase italic text-chrome tracking-tighter mb-4">{t('home.code.title')}</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 md:gap-12 max-w-4xl mx-auto">
            {[
              ...
              >
                <div className="w-16 h-16 rounded-full border border-inverse/10 flex items-center justify-center mb-6 bg-engine shadow-inner">
                  <principle.icon className="w-6 h-6 text-primary" />
                </div>
                <h3 className="text-2xl font-display font-black uppercase italic text-chrome mb-3 tracking-widest">{principle.title}</h3>
      ...
      <section className="py-24 bg-engine relative">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="order-1 lg:order-2">
              <h2 className="text-3xl md:text-5xl font-display font-black uppercase italic text-chrome tracking-tighter mb-8">
              ...
              <div className="space-y-8">
                {[
                  ...
                  <div key={i} className="flex gap-4">
                    <div className="w-12 h-12 shrink-0 bg-oil border border-inverse/10 flex items-center justify-center">
                      <item.icon className="w-5 h-5 text-primary" />
                    </div>
                    <div>
                      <h4 className="text-lg font-display font-bold uppercase italic text-chrome mb-1">{item.title}</h4>
      ...
      {/* 5. Final CTA Section */}
      <section className="py-32 relative bg-oil overflow-hidden border-t border-inverse/5">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
          <h2 className="text-4xl md:text-6xl font-display font-black uppercase italic text-chrome tracking-tighter mb-6">
            {t('home.cta.title')}
          </h2>
